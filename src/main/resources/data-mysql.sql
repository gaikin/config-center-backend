INSERT IGNORE INTO page_menu (id, region_id, menu_code, menu_name, url_pattern, status, create_time, created_by, update_time, updated_by)
...
INSERT IGNORE INTO page_resource (id, menu_code, page_name, page_code, owner_org_id, status, current_version_id, create_time, created_by, update_time, updated_by)
VALUES
...
INSERT IGNORE INTO page_element (id, page_resource_id, logic_name, selector, selector_type, frame_location, create_time, created_by, update_time, updated_by)
VALUES
...
INSERT IGNORE INTO business_field (id, code, name, scope, page_resource_id, value_type, required, description, owner_org_id, status, current_version, aliases_json, create_time, created_by, update_time, updated_by)
VALUES
(6101, 'field_customer_name', '客户姓名', 'GLOBAL', NULL, 'STRING', 1, '用于客户身份信息展示', 'head-office', 'ACTIVE', 1, '["customer_name"]', CURRENT_TIMESTAMP, 'system.seed', CURRENT_TIMESTAMP, 'system.seed'),
(6102, 'field_risk_level', '风险等级', 'PAGE_RESOURCE', 100, 'STRING', 0, '页面风险等级字段', '100001', 'DRAFT', 1, '["risk_level"]', CURRENT_TIMESTAMP, 'system.seed', CURRENT_TIMESTAMP, 'system.seed');

INSERT IGNORE INTO page_field_binding (id, page_resource_id, business_field_code, page_element_id, required, create_time, created_by, update_time, updated_by)
VALUES
(6201, 100, 'field_customer_name', 6001, 1, CURRENT_TIMESTAMP, 'system.seed', CURRENT_TIMESTAMP, 'system.seed');

INSERT IGNORE INTO interface_definition (
...
INSERT IGNORE INTO rule_definition (id, rule_name, page_resource_id, owner_org_id, trigger_mode, status, current_version_id, content_json, create_time, created_by, update_time, updated_by)
...
INSERT IGNORE INTO rule_condition_group (id, rule_id, logic_type, parent_group_id, create_time, created_by, update_time, updated_by)
VALUES (301, 300, 'AND', NULL, CURRENT_TIMESTAMP, 'system.seed', CURRENT_TIMESTAMP, 'system.seed');

INSERT IGNORE INTO rule_condition (id, rule_id, group_id, left_json, operator, right_json, create_time, created_by, update_time, updated_by)
...
INSERT IGNORE INTO data_processor (id, name, param_count, function_code, status, used_by_count, create_time, created_by, update_time, updated_by)
VALUES
...
INSERT IGNORE INTO context_variable (id, variable_key, label, value_source, static_value, script_content, status, owner_org_id, create_time, created_by, update_time, updated_by)
VALUES
...
INSERT IGNORE INTO publish_operation_log (id, action, resource_type, resource_id, resource_name, operator, effective_scope_type, effective_org_ids_json, effective_scope_summary, approval_ticket_id, approval_source, approval_status, create_time, created_by, update_time, updated_by)
...
INSERT IGNORE INTO job_scene_node (id, scene_id, node_type, name, order_no, enabled, config_json, create_time, created_by, update_time, updated_by)
VALUES
(90011, 9001, 'page_get', '页面取值1', 1, 1, '{"field":"customer_name"}', CURRENT_TIMESTAMP, 'system.seed', CURRENT_TIMESTAMP, 'system.seed'),
(90012, 9001, 'api_call', '接口调用1', 2, 1, '{"schemaVersion":2,"interfaceId":200,"inputBindings":{},"outputPaths":["$.data.score"]}', CURRENT_TIMESTAMP, 'system.seed', CURRENT_TIMESTAMP, 'system.seed'),
(90013, 9001, 'js_script', '脚本处理1', 3, 1, '{"schemaVersion":2,"scriptId":"risk_transform","scriptCode":"return { scoreTag: String(input.riskRef) + ''_HIGH'' };","inputBindings":{"riskRef":{"sourceType":"REFERENCE","value":"{{node_90012_score}}"}},"outputKeys":["scoreTag"],"script":"risk_transform"}', CURRENT_TIMESTAMP, 'system.seed', CURRENT_TIMESTAMP, 'system.seed'),
(90014, 9001, 'page_set', '页面写值1', 4, 1, '{"target":"risk_level","valueType":"REFERENCE","value":"{{node_90013_scoretag}}"}', CURRENT_TIMESTAMP, 'system.seed', CURRENT_TIMESTAMP, 'system.seed');

INSERT IGNORE INTO job_scene (
...
VALUES (
  ...
  100, 'Loan Apply Page', 'AUTO_AFTER_PROMPT', 0, 0,
  '重新执行', 86, 78, 'ACTIVE', 30, 1,
  CURRENT_TIMESTAMP, 'system.seed', CURRENT_TIMESTAMP, 'system.seed'
);

INSERT IGNORE INTO job_execution (id, scene_id, scene_name, trigger_source, result, fallback_to_manual, detail, started_at, finished_at, create_time, created_by, update_time, updated_by)
VALUES (91001, 9001, '脚本链路测试', 'MANUAL_RETRY', 'SUCCESS', 0, '全部节点执行成功', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system.seed', CURRENT_TIMESTAMP, 'system.seed');

INSERT IGNORE INTO prompt_trigger_log (
...
INSERT IGNORE INTO permission_resource (id, resource_code, resource_name, resource_type, resource_path, page_path, status, order_no, description, create_time, created_by, update_time, updated_by)
VALUES
...
INSERT IGNORE INTO cc_role (id, name, role_type, status, org_scope_id, create_time, created_by, update_time, updated_by)
VALUES
...
INSERT IGNORE INTO role_resource_grant (id, role_id, resource_code, create_time, created_by, update_time, updated_by)
VALUES
...
INSERT IGNORE INTO user_role_binding (id, user_id, role_id, status, create_time, created_by, update_time, updated_by)
VALUES
...
INSERT IGNORE INTO general_config_item (id, group_key, item_key, item_value, description, status, order_no, create_time, created_by, update_time, updated_by)
VALUES
...
INSERT IGNORE INTO menu_sdk_policy (id, menu_code, menu_name, prompt_gray_enabled, prompt_gray_version, prompt_gray_org_ids_json, job_gray_enabled, job_gray_version, job_gray_org_ids_json, effective_start, effective_end, status, create_time, created_by, update_time, updated_by)
VALUES (94001, 'dashboard', '看板', 1, '1.3.1-rc1', '["head-office"]', 0, NULL, '[]', CURRENT_TIMESTAMP, DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 7 DAY), 'ACTIVE', CURRENT_TIMESTAMP, 'system.seed', CURRENT_TIMESTAMP, 'system.seed');
